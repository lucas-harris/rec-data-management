...
class DateEntryScript:
    ...
    '''Creates empty variables to be placed in the database'''
    ...
    '''Saves attributes of the datetime parameter as independent variables'''
    ...
    '''Finds the position of a week in the year starting in the first week of July'''
    '''The Rec's fiscal year starts on the first Monday of July'''
    ...
    '''Saves the date into the database'''
